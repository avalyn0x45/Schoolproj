...
var Buffer2 = class {
  ...
  _reflowLarger(newCols, newRows) {
    ...
    if (toRemove.length > 0) {
      ...
      const isWindowsMode = this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0;
      if (isWindowsMode) {
        for (let i2 = toRemove.length / 2 - 1; i2 >= 0; i2--) {
          if (toRemove[i2 * 2 + 0] > this.ybase + removedInViewport) {
            removedInViewport += toRemove[i2 * 2 + 1];
          }
        }
      }
      ...
      if (isWindowsMode) {
        if (removedInViewport > 0) {
          for (let i2 = 0; i2 < removedInViewport; i2++) {
  ...
  _reflowSmaller(newCols, newRows) {
    ...
    const isWindowsMode = this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0;
    if (isWindowsMode) {
      for (let i2 = toInsert.length - 1; i2 >= 0; i2--) {
        if (toInsert[i2].start > this.ybase + addedInViewport) {
          addedInViewport += toInsert[i2].newLines.length;
        }
      }
    }
    ...
    if (isWindowsMode) {
      if (addedInViewport > 0) {
        ...
        for (let i2 = this.lines.length - 1; i2 >= this.ybase + this.y; i2--) {
          const line = this.lines.get(i2);
        ...
        if (emptyLinesToRemove > 0) {
          for (let i2 = 0; i2 < emptyLinesToRemove; i2++) {
            this.lines.pop();
          }
          if (this.ybase === this.ydisp) {
